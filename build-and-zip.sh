...
package_build() {
    ...
    PUBLISH_PATH="./PackageManager/Community.PowerToys.Run.Plugin.PackageManager/bin/Release/net9.0-windows10.0.22621.0/$ARCH/publish"
    DEST="./PackageManager/Publish/$CLEAN_ARCH"
